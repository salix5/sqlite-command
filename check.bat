...
sqlite3.exe ..\cdb\cards.cdb <cmd\check_tmp.txt
sqlite3.exe ..\cdb\cards.cdb <cmd\check_space.txt
sqlite3.exe ..\cdb\expansions\pre-release.cdb <cmd\check_space.txt
sqlite3.exe ..\cdb\expansions\pre-release.cdb <cmd\check_ending.txt
pause
